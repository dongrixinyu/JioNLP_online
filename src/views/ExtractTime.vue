      ...
      <a-layout style="display: block">
        <div v-if="response.is_ok == true && first_show == false">
          ...
          <div style="background: #fff; padding: 10px; padding-bottom: 10px">
            ...
            >
            <a-tag color="#149ef9"
              ><font size="2.5"><b>时间点</b>(time_point)</font></a-tag
            >
            <a-tag color="#0f6ec9"
              ><font size="2.5"><b>时间范围</b>(time_span)</font></a-tag
            >
            <a-tag color="#57a028"
              ><font size="2.5"><b>时间段</b>(time_delta)</font></a-tag
            >
            <a-tag color="#f14f50"
              ><font size="2.5"><b>时间周期</b>(time_period)</font></a-tag
            >
          </div>
        </div>
